...
set style line 1 lc rgb "#1b9e77" lw 2.0 pt 7 ps 0.75
set style line 2 lc rgb "#d95f02" lw 2.0 pt 5 ps 0.75
...
if (yBcol>0) {
  plot \
    DATA1 using xcol:yAcol:sdAcol with yerrorbars lw eblw lc rgb "#1b9e77" notitle, \
    DATA1 using xcol:yAcol        with linespoints ls 1 title nameA, \
    DATA1 using xcol:yBcol:sdBcol with yerrorbars lw eblw lc rgb "#d95f02" notitle, \
    DATA1 using xcol:yBcol        with linespoints ls 2 title nameB
} else {
  plot \
    DATA1 using xcol:yAcol:sdAcol with yerrorbars lw eblw lc rgb "#1b9e77" notitle, \
    DATA1 using xcol:yAcol        with linespoints ls 1 title nameA
...
if (yBcol>0) {
  plot \
    DATA2 using xcol:yAcol:sdAcol with yerrorbars lw eblw lc rgb "#1b9e77" notitle, \
    DATA2 using xcol:yAcol        with linespoints ls 1 notitle, \
    DATA2 using xcol:yBcol:sdBcol with yerrorbars lw eblw lc rgb "#d95f02" notitle, \
    DATA2 using xcol:yBcol        with linespoints ls 2 notitle
} else {
  plot \
    DATA2 using xcol:yAcol:sdAcol with yerrorbars lw eblw lc rgb "#1b9e77" notitle, \
    DATA2 using xcol:yAcol        with linespoints ls 1 notitle
...
if (yBcol>0) {
  plot \
    DATA3 using xcol:yAcol:sdAcol with yerrorbars lw eblw lc rgb "#1b9e77" notitle, \
    DATA3 using xcol:yAcol        with linespoints ls 1 notitle, \
    DATA3 using xcol:yBcol:sdBcol with yerrorbars lw eblw lc rgb "#d95f02" notitle, \
    DATA3 using xcol:yBcol        with linespoints ls 2 notitle
} else {
  plot \
    DATA3 using xcol:yAcol:sdAcol with yerrorbars lw eblw lc rgb "#1b9e77" notitle, \
    DATA3 using xcol:yAcol        with linespoints ls 1 notitle
