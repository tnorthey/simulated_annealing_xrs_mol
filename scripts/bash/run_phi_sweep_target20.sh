...
#   N_WORKERS=8 STARTING_XYZ=xyz/start.xyz ./scripts/bash/run_phi_sweep_target20.sh
#
# Environment overrides (defaults shown):
#   N_WORKERS          64      parallel workers per Phi
#   RESULTS_DIR        results_phi_sweep   parent dir; each Phi -> phi_<value>/
#   STARTING_XYZ       (unset) fixed start geometry for all workers
