...
#
# Uses repo input.toml for SA/MM defaults. This script only passes
# experiment-specific CLI flags (q-grid, open/closed C1-C6, files, GPU).
#
# Usage:
...
echo "=== Figure 3 run ==="
echo "  config         = $CONFIG  (SA/MM defaults; this script does not generate a toml)"
